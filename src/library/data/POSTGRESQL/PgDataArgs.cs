...
namespace OpenTax.Engine.Library.Data.POSTGRESQL
{
    ...
    ///
    /// </summary>
    public static class PgDataArgs
    {
        //-----------------------------------------------------------------------------------------------------------------------------
        ...
        /// <returns></returns>
        public static PgDatParameters ToArguments(this String p_xmlarg)
        {
        ...
        /// <returns></returns>
        public static string ToXmlString(this PgDatParameters p_dbps)
        {
            return ((PgDatParameters)p_dbps.Clone()).GetXmlString();
        }
        ...
        /// <returns></returns>
        public static PgDatParameters ToParameters(this XmlPackage p_package)
        {
            var _result = new PgDatParameters();
        ...
        /// <returns></returns>
        public static XmlPackage ToXmlPackage(this PgDatParameters p_dbps, MKindOfPacking p_kindOfPacking = MKindOfPacking.Encrypted)
        {
            return ((PgDatParameters)p_dbps.Clone()).GetXmlPackage(p_kindOfPacking);
        }
        ...
        /// <returns></returns>
        public static bool ToBoolean(this PgDatParameter p_dbp)
        {
            var _result = false;
            ...
            if (p_dbp != null && p_dbp.Value != null)
            {
                ...
                else if (p_dbp.Value is String && p_dbp.Type == NpgsqlDbType.Varchar)
        ...
        /// <param name="p_dbp"></param>
        /// <returns></returns>
        public static decimal ToDecimal(this PgDatParameter p_dbp)
        {
            decimal _result = 0;
            ...
            if (p_dbp != null && p_dbp.Value != null)
            {
                ...
                else if (p_dbp.Value is String && p_dbp.Type == NpgsqlDbType.Numeric)
                    _result = Convert.ToDecimal(p_dbp.Value);
            }
        ...
        /// <param name="p_dbp"></param>
        /// <returns></returns>
        public static Int32 ToInt32(this PgDatParameter p_dbp)
        {
            Int32 _result = 0;
        ...
        /// <param name="p_dbp"></param>
        /// <returns></returns>
        public static Double ToDouble(this PgDatParameter p_dbp)
        {
            Double _result = 0;
        ...
        /// <param name="p_dbp"></param>
        /// <returns></returns>
        public static Int64 ToInt64(this PgDatParameter p_dbp)
        {
            Int64 _result = 0;
        ...
        /// <param name="p_dbp"></param>
        /// <returns></returns>
        public static DateTime ToDateTime(this PgDatParameter p_dbp)
        {
            ...
            if (p_dbp != null && p_dbp.Value != null)
            {
                ...
                else if (p_dbp.Value is String && p_dbp.Type == NpgsqlDbType.TimestampTz)
