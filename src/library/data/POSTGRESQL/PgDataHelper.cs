...
namespace OpenTax.Engine.Library.Data.POSTGRESQL
{
    ...
    public class PgDataHelper
    {
        ...
        //private OpenTax.Engine.Library.Data.POSTGRESQL.PgDeltaHelper DeltaHelper
        //{
        //    get
        //    {
        ...
        private string _bldDataDelSQL(DataRow p_rows)
        {
            ...
            for (int _key = 0; _keys.Length > _key; _key++)
            {
                ...
                Object _object = p_rows[_column_name, DataRowVersion.Original];
        ...
        private string _bldDataUpdSQL(DataRow p_rows)
        {
            ...
            foreach (DataColumn _col in p_rows.Table.Columns)
            {
                if (_col.AutoIncrement == false)
                {
                    ...
                    {
                        Object _object = p_rows[_column_name];
        ...
        //{
        //    NpglDatCommand _dbc = new NpglDatCommand(p_cmdtxt);
        //    return SelectDataSet(p_connection_string, CommandType.Text, p_cmdtxt, _dbc.Name);
        //}

        public DataSet SelectDataSet(string p_connection_string, string p_cmdtxt, PgDatParameters p_dbps)
        {
            return SelectDataSet(p_connection_string, CommandType.Text, p_cmdtxt, _splitTableName(p_cmdtxt), p_dbps);
        }
        ...
        //        foreach (NpglDatCommand _dbc in p_dbcs)
        ...
        /// <returns></returns>
        public object SelectScalar(string p_connection_string, string p_cmdtxt, PgDatParameters p_dbps)
        {
            return ExecuteScalar(p_connection_string, CommandType.Text, p_cmdtxt, p_dbps);
        }
        ...
        /// <param name="p_dbps"></param>
        /// <returns></returns>
        public NpgsqlDataReader ExecuteReader(string p_connection_string, string p_cmdtxt, PgDatParameters p_dbps)
        {
            return ExecuteReader(p_connection_string, CommandType.Text, p_cmdtxt, p_dbps);
        }
        ...
        /// <param name="p_dbps"></param>
        /// <returns></returns>
        public int ExecuteText(string p_connection_string, string p_cmdtxt, PgDatParameters p_dbps)
        {
            return ExecuteNonQuery(p_connection_string, CommandType.Text, p_cmdtxt, p_dbps);
        }
        ...
        /// <param name="p_cmdtxts"></param>
        /// <returns></returns>
        public int ExecuteText(string p_connection_string, PgDatParameters p_dbps, params string[] p_cmdtxts)
        {
            var _result = 0;
            ...
            using (NpgsqlConnection _sqlconn = new NpgsqlConnection(p_connection_string))
            {
                ...
                try
                {
                    for (int i = 0; i < p_cmdtxts.Length; i++)
                    {
                        if (p_cmdtxts[i] != null && p_cmdtxts[i] != "")
                        {
                            ExecuteNonQuery(transaction, CommandType.Text, p_cmdtxts[i], p_dbps);
                            _result++;
                        }
                    }
        ...
        ///// <returns></returns>
        //public PgDatParameters GetNpgsqlParameters(string p_connection_string, string p_spName)
        //{
        //    var _dbps = new PgDatParameters();

        //    NpgsqlParameter[] _sbps = NpgsqlHelperParameterCache.GetSpParameterSet(p_connection_string, p_spName);
        ...
        /// <param name="p_dbps"></param>
        /// <returns></returns>
        public int ExecuteProc(string p_connection_string, string p_spName, PgDatParameters p_dbps)
        {
            var _result = -1;

            NpgsqlParameter[] _params = p_dbps;
        ...
        /// <param name="p_dbps"></param>
        /// <returns></returns>
        public DataSet ExecuteProcSet(string p_connection_string, string p_spName, PgDatParameters p_dbps)
        {
            var _result = new DataSet();
        ...
        /// <param name="p_dbps"></param>
        /// <returns></returns>
        public DataSet ExecuteDataSet(string p_connection_string, string p_cmdtxt, PgDatParameters p_dbps)
        {
            return ExecuteDataSet(p_connection_string, CommandType.Text, p_cmdtxt, p_dbps);
        }
