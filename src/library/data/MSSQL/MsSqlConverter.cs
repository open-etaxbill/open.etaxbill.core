...
namespace OpenTax.Engine.Library.Data.MSSQL
{
    ...
    public class MsSqlConverter
    {
        ...
        /// </summary>
        /// <param name="p_msquery"></param>
        /// <returns></returns>
        public string MS2MySQL(string p_msquery)
        {
            var _sql = p_msquery;
        ...
        /// <returns></returns>
        private string ConvertTop2Limit(string p_mssql)
        {
            var _result = "";
            ArrayList _top = new ArrayList();

            string[] _words = p_mssql.Split(' ', '\t', '\r', '\n');
        ...
        /// </summary>
        /// <param name="p_myquery"></param>
        /// <returns></returns>
        public string MY2MSSQL(string p_myquery)
        {
            var _sql = p_myquery;
        ...
        /// <returns></returns>
        private string ConvertConcat2Plus(string p_SQL)
        {
            // CONCAT으로 문장을 나눈다.
            ...
            var _result = "";
            string[] _temp = Regex.Split(p_SQL, "concat\\(", RegexOptions.IgnoreCase);
