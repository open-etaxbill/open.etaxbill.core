...
namespace OpenTax.Engine.Library.Data.MSSQL
{
    ...
    public class MsDatParameter : ISerializable
    {
        ...
        public MsDatParameter(string p_name, SqlDbType p_type, ParameterDirection p_direction, object p_value)
        ...
        /// <param name="p_value"></param>
        /// <param name="p_direction"></param>
        public MsDatParameter(string p_name, string p_fieldType, SqlDbType p_type, ParameterDirection p_direction, object p_value)
        {
            m_name = p_name;
        ...
        public MsDatParameter(SerializationInfo p_info, StreamingContext p_context)
        {
            if (p_info == null)
            ...
            m_type = (SqlDbType)p_info.GetValue("type", typeof(SqlDbType));
        ...
        /// <returns></returns>
        public static implicit operator SqlParameter(MsDatParameter p_dbp)
        {
            SqlParameter _result = new SqlParameter(p_dbp.Name, p_dbp.Value);

            _result.SqlDbType = p_dbp.Type;
