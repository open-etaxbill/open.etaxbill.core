...
namespace OdinSdk.OdinLib.Data.POSTGRESQL
{
    ...
    public class PgDatParameter : ISerializable
    {
        ...
        public PgDatParameter(string name, NpgsqlDbType db_type, ParameterDirection direction, object value)
        ...
        /// <param name="value"></param>
        /// <param name="direction"></param>
        public PgDatParameter(string name, string field_type, NpgsqlDbType db_type, ParameterDirection direction, object value)
        {
            m_name = name;
        ...
        public PgDatParameter(SerializationInfo serialization_info, StreamingContext streaming_context)
        {
            ...
            m_type = (NpgsqlDbType)serialization_info.GetValue("type", typeof(NpgsqlDbType));
        ...
        /// <returns></returns>
        public static implicit operator NpgsqlParameter(PgDatParameter db_param)
        {
            NpgsqlParameter _result = new NpgsqlParameter(db_param.Name, db_param.Value);

            _result.NpgsqlDbType = db_param.Type;
