...
namespace OpenTax.Engine.Provider
{
    public class Host : IDisposable
    {
        ...
        public OpenTax.Engine.Library.UAppHelper UAppHelper
        {
            ...
            {
                if (m_appHelper == null)
                    m_appHelper = new OpenTax.Engine.Library.UAppHelper(IProvider.Manager);

                return m_appHelper;
            }
        }

        private OdinSdk.BaseLib.Queue.QWriter p_qwriter = null;
        private OdinSdk.BaseLib.Queue.QWriter QWriter
        {
            get
            {
                if (p_qwriter == null)
                    p_qwriter = new OdinSdk.BaseLib.Queue.QWriter();
        ...
        // 
        //-------------------------------------------------------------------------------------------------------------------------
        private OdinSdk.BaseLib.Communication.WcfServer m_wcf_service = null;
        private OdinSdk.BaseLib.Communication.WcfServer WcfService
        {
            get
            {
                if (m_wcf_service == null)
                {
                    ...
                    m_wcf_service = new OdinSdk.BaseLib.Communication.WcfServer(
