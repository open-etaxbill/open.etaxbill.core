...
namespace OpenETaxBill.Engine.Collector
{
    ...
    public class ELogger : IDisposable
    {
        ...
        private OdinSdk.BaseLib.Logging.OEventLog m_oeventLog = null;
        private OdinSdk.BaseLib.Logging.OEventLog OEventLogger
        {
            get
            {
                if (m_oeventLog == null)
                    m_oeventLog = new OdinSdk.BaseLib.Logging.OEventLog(ICollector.Proxy.EventSource);
